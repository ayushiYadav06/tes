...
export default function HomePage() {
  ...
  className={`absolute inset-0 bg-cover bg-center bg-no-repeat hero-zoom ${
    currentIndex === 0 ? "hero-zoom-active opacity-100" : "hero-zoom-inactive opacity-0"
  }`}

          style={{
            backgroundImage: `linear-gradient(135deg, rgba(0,0,0,0.65), rgba(14,165,233,0.2)), url('/plant 3.jpg')`,
          }}
        />
            ...
            <div
  className={`absolute inset-0 bg-cover bg-center bg-no-repeat hero-zoom ${
    currentIndex === 1 ? "hero-zoom-active opacity-100" : "hero-zoom-inactive opacity-0"
  }`}
          style={{
            backgroundImage: `linear-gradient(135deg, rgba(0,0,0,0.65), rgba(14,165,233,0.2)), url('/plant 2.jpg')`,
          }}
        />
        {/* <div
          className={`absolute inset-0 bg-cover bg-center bg-no-repeat transition-opacity duration-1000 ${currentIndex === 2 ? "opacity-100" : "opacity-0"
            ...
            <div
  className={`absolute inset-0 bg-cover bg-center bg-no-repeat hero-zoom ${
    currentIndex === 2 ? "hero-zoom-active opacity-100" : "hero-zoom-inactive opacity-0"
  }`}
          style={{
            backgroundImage: `linear-gradient(135deg, rgba(0,0,0,0.65), rgba(14,165,233,0.2)), url('/plant 1.jpg')`,
          }}
        />
