            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-black mb-4">
                  ...
                  manufacturing companies in India, TTIL is a trusted name in the electric power sector.
                </p>

                <p className="text-lg text-black mb-4">
                  Under the visionary leadership of <strong>Mr. Jaideep Jain (CMD)</strong>, TTIL is
                  committed to delivering reliable and high-performance solutions across the globe.
                </p>

                <p className="text-lg text-black mb-4">
                  TTIL is a multi-product and service organization specializing in the manufacturing,
                  supply, erection, and testing of Power and Distribution Transformers, as well as the
                  execution of complete substations as turnkey EPC projects.
                </p>

                <p className="text-lg text-black mb-4">
                  With over 52 years of industry credibility, the company is fully aligned with
                  international and Indian quality standards, ensuring customer satisfaction through
                  continuous innovation and commitment.
                </p>

                <p className="text-lg text-black mb-4">
                  TTIL is certified with ISO 9001, ISO 14001, and ISO 45001, and has earned a strong
                  brand reputation in both domestic and global markets.
                </p>

                <p className="text-lg text-black mb-4">
                  The company operates an in-house NABL-accredited transformer testing laboratory
                  as per ISO/IEC 17025:2017, enabling routine, type, and special tests to ensure
                  top-tier performance and compliance.
                </p>

                <p className="text-lg text-black mb-4">
                  TTIL manufactures a wide range of Power and Distribution Transformers from
                  25 kVA to 200 MVA, with voltage classes up to 220 kV. The company also produces
                  Inverter Duty Transformers (IDTs) with copper or aluminum windings, customized
                  as per client requirements.
                </p>

                <p className="text-lg text-black mb-4">
                  A newly constructed Vapour Phase Drying (VPD) plant with a 300 kW heating capacity
                  significantly enhances production capability and quality assurance.
                </p>

                <p className="text-lg text-black mb-4">
                  Headquartered in Bhopal, Madhya Pradesh (India), TTIL has an extensive sales and
                  service network across India, Asia, the Middle East, Africa, the Americas, and Europe.
                </p>

                <p className="text-lg text-black">
                  Serving electrical utilities, government organizations, and private companies,
                  TTIL remains grounded in its founding principles of integrity, uncompromising
                  standards, reliable services, and unwavering commitment—always striving to deliver
                  the best by being the best.
                </p>
